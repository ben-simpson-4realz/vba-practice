Attribute VB_Name = "AccessDatabase"
Option Explicit
Sub AccessDatabase()
    ...
    'Open DB connection
    'For SQL Server data source is server, for access it's path to db
    cnSQL.Open "Provider=Microsoft.ACE.OLEDB.12.0; Data source = C:\Users\Ben\Documents\Study\VBA\Company.accdb"
    ...
    'INSERT STATEMENT
    sqlString = "INSERT INTO PEOPLE (name, age) VALUES ('Chipchan',100)"
